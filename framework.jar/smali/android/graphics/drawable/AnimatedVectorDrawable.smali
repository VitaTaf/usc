...
.field private final mUpdateAnim:Landroid/animation/ValueAnimator;
...
.method private constructor <init>(Landroid/graphics/drawable/AnimatedVectorDrawable$AnimatedVectorDrawableState;Landroid/content/res/Resources;)V
    ...
    iput-object v0, p0, Landroid/graphics/drawable/AnimatedVectorDrawable;->mUpdateAnim:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, Landroid/graphics/drawable/AnimatedVectorDrawable;->mUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    new-instance v0, Landroid/graphics/drawable/AnimatedVectorDrawable$3;

    invoke-direct {v0, p0}, Landroid/graphics/drawable/AnimatedVectorDrawable$3;-><init>(Landroid/graphics/drawable/AnimatedVectorDrawable;)V
...
.method static synthetic access$100(Landroid/graphics/drawable/AnimatedVectorDrawable;)Landroid/animation/ValueAnimator;
    .locals 1
    .param p0, "x0"    # Landroid/graphics/drawable/AnimatedVectorDrawable;

    .prologue
    iget-object v0, p0, Landroid/graphics/drawable/AnimatedVectorDrawable;->mUpdateAnim:Landroid/animation/ValueAnimator;

    return-object v0
.end method

.method static synthetic access$200(Landroid/graphics/drawable/AnimatedVectorDrawable;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Landroid/graphics/drawable/AnimatedVectorDrawable;
...
.method private ensureAnimatorSet()V
    ...
    iget-object v1, p0, Landroid/graphics/drawable/AnimatedVectorDrawable;->mUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    new-instance v1, Landroid/graphics/drawable/AnimatedVectorDrawable$2;

    invoke-direct {v1, p0}, Landroid/graphics/drawable/AnimatedVectorDrawable$2;-><init>(Landroid/graphics/drawable/AnimatedVectorDrawable;)V
...
.method public registerAnimationCallback(Landroid/graphics/drawable/Animatable2$AnimationCallback;)V
    ...
    new-instance v0, Landroid/graphics/drawable/AnimatedVectorDrawable$4;

    invoke-direct {v0, p0}, Landroid/graphics/drawable/AnimatedVectorDrawable$4;-><init>(Landroid/graphics/drawable/AnimatedVectorDrawable;)V
