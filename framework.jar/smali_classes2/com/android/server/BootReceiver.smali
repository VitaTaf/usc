...
.method private logBootEvents(Landroid/content/Context;)V
    ...
    const-string v7, "ro.manufacturedate"
    ...
    const-string v6, "persist.sys.reboot_reason"
    ...
    const-string v6, "sys.runtime.restart.times"
    ...
    const-string v7, "ro.boot.console"
    ...
    :cond_a
    const-string v6, "sys.sf.restart"
    ...
    .end local v14    # "h":Ljava/lang/String;
    :cond_b
    const-string v6, "sys.wd.restart"
    ...
    .end local v14    # "h":Ljava/lang/String;
    :cond_c
    const-string v6, "sys.frp.restart"
    ...
    const-string v6, "sys.runtime.restart.last"
    ...
    const-string v6, "rolling restart"
